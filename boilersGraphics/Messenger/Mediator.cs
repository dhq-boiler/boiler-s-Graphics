...
public class Mediator
{
    ...
    private readonly Dictionary<object, List<WeakAction>> _registeredHandlers = new();
    ...
    public void Register(object view)
    {
        ...
        foreach (var mi in view.GetType().GetMethods(BindingFlags.Instance | BindingFlags.Static |
