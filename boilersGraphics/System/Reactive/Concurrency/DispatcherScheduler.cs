...
///// </summary>
///// <remarks>
/////     This scheduler type is typically used indirectly through the
/////     <see cref="Linq.DispatcherObservable.ObserveOnDispatcher{TSource}(IObservable{TSource})" /> and
/////     <see cref="Linq.DispatcherObservable.SubscribeOnDispatcher{TSource}(IObservable{TSource})" /> methods that use the
/////     Dispatcher on the calling thread.
///// </remarks>
//public class DispatcherScheduler : LocalScheduler, ISchedulerPeriodic
//{
//    /// <summary>
//    ///     Constructs a <see cref="DispatcherScheduler" /> that schedules units of work on the given
...
//    /// <summary>
//    ///     Constructs a <see cref="DispatcherScheduler" /> that schedules units of work on the given
//    ///     <see cref="System.Windows.Threading.Dispatcher" /> at the given priority.
//    /// </summary>
//    /// <param name="dispatcher"><see cref="DispatcherScheduler" /> to schedule work on.</param>
...
//    /// <summary>
//    ///     Gets the scheduler that schedules work on the <see cref="System.Windows.Threading.Dispatcher" /> for the current
//    ///     thread.
//    /// </summary>
...
//            if (dispatcher == null) throw new InvalidOperationException("NO_DISPATCHER_CURRENT_THREAD");
...
//    /// <summary>
//    ///     Schedules a periodic piece of work on the dispatcher, using a
//    ///     <see cref="System.Windows.Threading.DispatcherTimer" /> object.
//    /// </summary>
...
//            new Action(() =>
//            {
//                if (!d.IsDisposed) d.Disposable = action(this, state);
//            }),
//            Priority
//        );
...
//    /// <summary>
//    ///     Schedules an action to be executed after <paramref name="dueTime" /> on the dispatcher, using a
//    ///     <see cref="System.Windows.Threading.DispatcherTimer" /> object.
//    /// </summary>
//    /// <typeparam name="TState">The type of the state passed to the scheduled action.</typeparam>
//    /// <param name="state">State passed to the action to be executed.</param>
...
//        if (dt.Ticks == 0) return Schedule(state, action);
