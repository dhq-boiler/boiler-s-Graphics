...
internal class LinearGradientBrushPickerViewModel : BindableBase, INavigationAware
{
    ...
    public BindableReactiveProperty<Brush> TargetBrush { get; } = new();
    ...
    public NotifyCollectionChangedSynchronizedViewList<GradientStop> GradientStops { get; set; } = new ObservableList<GradientStop>().ToWritableNotifyCollectionChanged();
    ...
    public BindableReactiveProperty<GradientStop> SelectedGradientStop { get; } = new();
    public BindableReactiveProperty<Point> StartPoint { get; } = new();
    ...
    private void Sort(NotifyCollectionChangedSynchronizedViewList<GradientStop> gradientStops)
    {
    ...
    private void BuildTargetBrush()
    {
        LogManager.GetCurrentClassLogger()
            .Debug($"BuildTargetBrush StartPoint={StartPoint.Value}, EndPoint={EndPoint.Value}");
