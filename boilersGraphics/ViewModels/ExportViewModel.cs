    ...
    public class ExportViewModel : BindableBase, IDialogAware, IDisposable
    {
        ...
        public ExportViewModel()
        {
            ...
            SliceRect.Subscribe(x =>
            {
                ...
                RenderTargetBitmap rtb = Renderer.Render(x, designerCanvas, diagramViewModel, backgroundItem);
        ...
        {
            var backgroundItem = diagramViewModel.BackgroundItem.Value;
            RenderTargetBitmap rtb = Renderer.Render(SliceRect.Value, designerCanvas, diagramViewModel, backgroundItem);
