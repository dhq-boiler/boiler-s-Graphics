...
public class ExportViewModel : BindableBase, IDialogAware, IDisposable
{
        ...
        SliceRect.Subscribe(x =>
            {
                ...
                var rtb = renderer.Render(x, designerCanvas, diagramViewModel, backgroundItem, new System.Windows.Point());
        ...
        DiagramViewModel diagramViewModel)
    {
        var backgroundItem = diagramViewModel.BackgroundItem.Value;
        var renderer = new Renderer(new WpfVisualTreeHelper());
        var rtb = renderer.Render(SliceRect.Value, designerCanvas, diagramViewModel, backgroundItem, new System.Windows.Point());
