...
namespace boilersGraphics.ViewModels
{
    internal class RadialGradientBrushPickerViewModel : BindableBase, INavigationAware
    {
        ...
        public ReactivePropertySlim<Point> GradientOrigin { get; } = new ReactivePropertySlim<Point>();
        public ReactivePropertySlim<Point> Center { get; } = new ReactivePropertySlim<Point>();
        ...
        {
            LogManager.GetCurrentClassLogger().Debug($"BuildTargetBrush GradientOrigin={GradientOrigin.Value}, Center={Center.Value}, RadiusX={RadiusX.Value}, RadiusY={RadiusY.Value}");
