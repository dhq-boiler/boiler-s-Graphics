...
public class ToolBarViewModel
{
    ...
    private void InitializeToolItems2(MainWindowViewModel mainWindowViewModel)
    {
        var toolItemData = new ToolItemData("minimap", "pack://application:,,,/Assets/img/minimap.png",
            ...
            new DelegateCommand(() =>
            {
                mainWindowViewModel.DiagramViewModel.EnableMiniMap.Value =
                    !mainWindowViewModel.DiagramViewModel.EnableMiniMap.Value;
            }));
        ...
        toolItemData = new ToolItemData("combine", "pack://application:,,,/Assets/img/icon_Combine_union_dark.png",
            ...
            new DelegateCommand(() =>
            {
                mainWindowViewModel.DiagramViewModel.EnableCombine.Value =
                    !mainWindowViewModel.DiagramViewModel.EnableCombine.Value;
            }));
        ToolItems2.Add(toolItemData);
        ...
        toolItemData = new ToolItemData("layers", "pack://application:,,,/Assets/img/icon_Layers.png",
            ...
            new DelegateCommand(() =>
            {
                mainWindowViewModel.DiagramViewModel.EnableLayers.Value =
                    !mainWindowViewModel.DiagramViewModel.EnableLayers.Value;
            }));
        ToolItems2.Add(toolItemData);
        ...
        toolItemData = new ToolItemData("workHistory", "pack://application:,,,/Assets/img/work_history_dark.png",
            ...
            new DelegateCommand(() =>
            {
                mainWindowViewModel.DiagramViewModel.EnableWorkHistory.Value =
                    !mainWindowViewModel.DiagramViewModel.EnableWorkHistory.Value;
            }));
        ToolItems2.Add(toolItemData);
