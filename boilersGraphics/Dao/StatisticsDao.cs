...
internal class StatisticsDao : Dao<Statistics>
{
    ...
    protected override Statistics ToEntity(IDataRecord reader)
    {
        return new Statistics
        {
            ...
            NumberOfTimesTheFileWasOpenedBySpecifyingIt =
                reader.SafeGetInt("NumberOfTimesTheFileWasOpenedBySpecifyingIt", Table),
            NumberOfTimesTheAutoSaveFileIsSpecifiedAndOpened =
                reader.SafeGetInt("NumberOfTimesTheAutoSaveFileIsSpecifiedAndOpened", Table),
            NumberOfClicksWithThePointerTool = reader.SafeGetInt("NumberOfClicksWithThePointerTool", Table),
            CumulativeTotalOfItemsSelectedWithTheLassoTool =
                reader.SafeGetInt("CumulativeTotalOfItemsSelectedWithTheLassoTool", Table),
            ...
            NumberOfTimesTheTopAndBottomAreCentered =
                reader.SafeGetInt("NumberOfTimesTheTopAndBottomAreCentered", Table),
            ...
            NumberOfTimesTheVersionInformationDialogWasDisplayed =
                reader.SafeGetInt("NumberOfTimesTheVersionInformationDialogWasDisplayed", Table),
            NumberOfTimesTheApplicationLogWasDisplayed =
                reader.SafeGetInt("NumberOfTimesTheApplicationLogWasDisplayed", Table),
            ...
            NumberOfPdfExports = reader.SafeGetInt("NumberOfPdfExports", Table)
        };
    }
}