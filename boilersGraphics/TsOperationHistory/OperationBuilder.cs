...
public partial class OperationBuilder
{
    ...
    /// <returns></returns>
    public IMergeableOperationBuilder MakeThrottle(Action execute, Action rollback, object key,
        TimeSpan convergeTimeSpan)
    {
    ...
    public IMergeableOperationBuilder MakeThrottle<T>(Action<T> execute, T newValue, T oldValue, object key,
        TimeSpan convergeTimeSpan)
    {
        var judge = new ThrottleMergeJudge<int>(key.GetHashCode(), convergeTimeSpan);
