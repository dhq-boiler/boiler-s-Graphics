...
/// <summary>
/// Phase 2-c: データジェネレータツール用 Behavior。
/// MonoTextBlockBehavior と同じ枠組み (ドラッグ開始点を覚えて MouseMove で DataGeneratorTextBlockAdorner を出す)。
/// </summary>
public class DataGeneratorTextBlockBehavior : Behavior<DesignerCanvas>
{
    ...
    private void AssociatedObject_MouseMove(object sender, MouseEventArgs e)
    {
        ...
        adornerLayer?.Add(new DataGeneratorTextBlockAdorner(canvas, _dragStartPoint));
