...
/// <summary>
/// Phase 2-b-2: モノスペーステキストツール用 Behavior。
/// LetterBehavior と同じ枠組み (ドラッグ開始点を覚えて MouseMove で MonoTextBlockAdorner を出す)。
/// </summary>
public class MonoTextBlockBehavior : Behavior<DesignerCanvas>
{
    ...
    private void AssociatedObject_MouseMove(object sender, MouseEventArgs e)
    {
        ...
        adornerLayer?.Add(new MonoTextBlockAdorner(canvas, _dragStartPoint));
