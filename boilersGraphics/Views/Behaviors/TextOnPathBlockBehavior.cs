...
/// <summary>
/// Phase 2.5-b: テキストパスツール用 Behavior。NumberSequenceBlockBehavior と同じ枠組み。
/// 配置後に PathReferenceId をユーザーに別途指定してもらう前提 (Phase 2.5 最小実装)。
/// </summary>
public class TextOnPathBlockBehavior : Behavior<DesignerCanvas>
{
    ...
    private void AssociatedObject_MouseMove(object sender, MouseEventArgs e)
    {
        ...
        adornerLayer?.Add(new TextOnPathBlockAdorner(canvas, _dragStartPoint));
