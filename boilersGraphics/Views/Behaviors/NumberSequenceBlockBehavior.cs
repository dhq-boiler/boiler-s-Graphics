...
/// <summary>
/// Phase 2-d: 数値列ツール用 Behavior。MonoTextBlockBehavior と同じ枠組み。
/// </summary>
public class NumberSequenceBlockBehavior : Behavior<DesignerCanvas>
{
    ...
    private void AssociatedObject_MouseMove(object sender, MouseEventArgs e)
    {
        ...
        adornerLayer?.Add(new NumberSequenceBlockAdorner(canvas, _dragStartPoint));
