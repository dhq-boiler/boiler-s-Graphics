...
internal static class Extensions2
{
    ...
    {
        var index = rdr.CheckColumnExists(columnName, table);

        var isNull = rdr.IsDBNull(index);

        return isNull
            ? throw new NullReferenceException($"expected bool value but {columnName} value is null")
            : rdr.GetBoolean(index);
    }
    ...
    public static Guid SafeGetGuid(this IDataRecord rdr, string columnName, ITable table)
    {
        ...
        return isNull
            ? throw new NullReferenceException($"expected Guid value but {columnName} value is null")
            : rdr.GetGuid(index);
    }

    public static string SafeGetString(this IDataRecord rdr, string columnName, ITable table)
    {
        var index = CheckColumnExists(rdr, columnName, table);
    ...
    public static int SafeGetInt(this IDataRecord rdr, string columnName, ITable table)
    {
        ...
        return isNull
            ? throw new NullReferenceException($"expected int value but {columnName} value is null")
            : rdr.GetInt32(index);
    }
    ...
    public static long SafeGetLong(this IDataRecord rdr, string columnName, ITable table)
    {
        ...
        return isNull
            ? throw new NullReferenceException($"expected long value but {columnName} value is null")
            : rdr.GetInt64(index);
    }
    ...
    public static int? SafeGetNullableInt(this IDataRecord rdr, string columnName, ITable table)
    {
        ...
        return isNull ? null : rdr.GetInt32(index);
    }
    ...
    public static long? SafeNullableGetLong(this IDataRecord rdr, string columnName, ITable table)
    {
        ...
        return isNull ? null : rdr.GetInt64(index);
    }
    ...
    public static DateTime? SafeGetNullableDateTime(this IDataRecord rdr, string columnName, ITable table)
    {
        ...
        return isNull ? null : rdr.GetDateTime(index);
    }
