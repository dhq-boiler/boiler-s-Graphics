...
{
    public static void AddNewBrushViewModel(DesignerCanvas AssociatedObject, ref BrushViewModel currentBrush,
        Point point)
    {
        currentBrush.Owner = AssociatedObject.DataContext as IDiagramViewModel;
        ...
        (AssociatedObject.DataContext as IDiagramViewModel).AddItemCommand.Execute(currentBrush);
