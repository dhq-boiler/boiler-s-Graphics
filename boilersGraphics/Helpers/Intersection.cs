...
namespace boilersGraphics.Helpers
{
    public static class Intersection
    {
        ...
        public static Tuple<Point[], double> FindPieSegmentIntersectionsSupportRotationLong(NPieViewModel pie, Point pt1, Point pt2, bool segment_only)
        {
            var cloneL = pie.CreateNEllipseViewModelLong() as NEllipseViewModel;
            // If the ellipse or line segment are empty, return no intersections.
            ...
            double discriminant;
            List<Point> points = new List<Point>();
            FindPieSegmentIntersectionsSupportRotationInternal(pie, pt1, pt2, segment_only, cloneL, out discriminant, points);

            // Return the points.
            return new Tuple<Point[], double>(points.ToArray(), discriminant);
        }

        public static Tuple<Point[], double> FindPieSegmentIntersectionsSupportRotationShort(NPieViewModel pie, Point pt1, Point pt2, bool segment_only)
        {
            var cloneS = pie.CreateNEllipseViewModelShort() as NEllipseViewModel;
            // If the ellipse or line segment are empty, return no intersections.
            ...
            double discriminant;
            List<Point> points = new List<Point>();
            FindPieSegmentIntersectionsSupportRotationInternal(pie, pt1, pt2, segment_only, cloneS, out discriminant, points);

            // Return the points.
            return new Tuple<Point[], double>(points.ToArray(), discriminant);
        }

        private static void FindPieSegmentIntersectionsSupportRotationInternal(NPieViewModel pie, Point pt1, Point pt2, bool segment_only, NEllipseViewModel clone, out double discriminant, List<Point> points)
        {
            // Make sure the rectangle has non-negative width and height.
            if (clone.Width.Value < 0)
            {
