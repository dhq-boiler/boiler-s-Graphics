...
/// <summary>
/// Phase 2.5-a: テキストマトリクスツールのドラッグ矩形プレビュー + 配置確定。
/// NumberSequenceBlockAdorner と同じ枠組み。
/// </summary>
public class TextMatrixBlockAdorner : Adorner
{
    ...
    public TextMatrixBlockAdorner(DesignerCanvas designerCanvas, Point? dragStartPoint)
        : base(designerCanvas)
    {
    ...
    protected override void OnMouseUp(MouseButtonEventArgs e)
    {
        ...
        {
            var vm = new TextMatrixBlockViewModel
            {
