...
/// <summary>
/// Phase 2-c: データジェネレータツールのドラッグ矩形プレビュー + 配置確定。
/// MonoTextBlockAdorner と同じ枠組み (MouseUp で DataGeneratorTextBlockViewModel を生成して Layer に追加)。
/// </summary>
public class DataGeneratorTextBlockAdorner : Adorner
{
    ...
    public DataGeneratorTextBlockAdorner(DesignerCanvas designerCanvas, Point? dragStartPoint)
        : base(designerCanvas)
    {
