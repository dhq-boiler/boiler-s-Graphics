...
public class BezierCurveAdorner : Adorner
{
    ...
    protected override void OnMouseUp(MouseButtonEventArgs e)
    {
        ...
        if (_startPoint.HasValue && _endPoint.HasValue)
        {
            ...
            var item = new BezierCurveViewModel((AdornedElement as DesignerCanvas).DataContext as IDiagramViewModel,
                _startPoint.Value, _endPoint.Value, BezierCurve.Evaluate(0.25, points),
                BezierCurve.Evaluate(0.75, points));
    ...
    protected override void OnRender(DrawingContext dc)
    {
        ...
        if (_startPoint.HasValue && _endPoint.HasValue)
        {
            ...
            using (var ctx = geometry.Open())
            {
                ...
                ctx.BezierTo(BezierCurve.Evaluate(0.25, points), BezierCurve.Evaluate(0.75, points), _endPoint.Value,
                    true, false);
            }
