...
/// <summary>
/// Phase 2-d: 数値列ツールのドラッグ矩形プレビュー + 配置確定。
/// MonoTextBlockAdorner と同じ枠組み。
/// </summary>
public class NumberSequenceBlockAdorner : Adorner
{
    ...
    public NumberSequenceBlockAdorner(DesignerCanvas designerCanvas, Point? dragStartPoint)
        : base(designerCanvas)
    {
