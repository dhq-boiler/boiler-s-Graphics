...
/// <summary>
/// Phase 2.5-b: テキストパスツールのドラッグ矩形プレビュー + 配置確定。
/// 配置時点では PathReferenceId は未設定。後続の編集 UI でユーザーに参照する PolyBezier を指定してもらう。
/// </summary>
public class TextOnPathBlockAdorner : Adorner
{
    ...
    public TextOnPathBlockAdorner(DesignerCanvas designerCanvas, Point? dragStartPoint)
        : base(designerCanvas)
    {
    ...
    protected override void OnMouseUp(MouseButtonEventArgs e)
    {
        ...
        {
            var vm = new TextOnPathBlockViewModel
            {
