...
[DefaultVersion(typeof(Version4))]
public class Statistics : PkIdEntity
{
    ...
    {
        get => _numberOfTimesTheFileWasOpenedBySpecifyingIt;
    ...
    {
        get => _numberOfTimesTheAutoSaveFileIsSpecifiedAndOpened;
    ...
    {
        get => _numberOfClicksWithThePointerTool;
