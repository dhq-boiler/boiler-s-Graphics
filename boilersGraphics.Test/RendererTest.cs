...
namespace boilersGraphics.Test
{
    ...
    public class RendererTest
    {
        ...
        public void 白色のみ全体を撮影()
        {
            ...
            var rtb = renderer.Render(null, designerCanvas, viewModel, viewModel.BackgroundItem.Value, new System.Windows.Point());
        ...
        public void 赤を撮影()
        {
            ...
            var renderer = new Renderer(mock.Object);
            var rtb = renderer.Render(new Rect(2, 1, 3, 3), designerCanvas, viewModel, viewModel.BackgroundItem.Value, new System.Windows.Point());
        ...
        public void 青を撮影()
        {
            ...
            var renderer = new Renderer(mock.Object);
            var rtb = renderer.Render(new Rect(3, 5, 6, 3), designerCanvas, viewModel, viewModel.BackgroundItem.Value, new System.Windows.Point());
        ...
        public void 青マージン１を撮影()
        {
            ...
            mock.Setup(x => x.GetDescendantBounds(blueRect)).Returns(new Rect(3, 5, 6, 3));
            var renderer = new Renderer(mock.Object);
            var rtb = renderer.Render(new Rect(2, 4, 8, 5), designerCanvas, viewModel, viewModel.BackgroundItem.Value, new System.Windows.Point());
