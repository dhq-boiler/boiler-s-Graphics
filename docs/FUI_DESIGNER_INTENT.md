...
### Phase 5.5: XAML アニメーション出力 (WPF / .NET MAUI 連携) 🌟 重点 — 完了 ✅
...
**設計仕様書 [`fui/phase5-5-xaml-export.md`](./fui/phase5-5-xaml-export.md) v1.0 確定** (2026-05-15、Q-1〜Q-12 全件「推奨案」で承認)。
**チュートリアル [`fui/phase5-5-tutorial.md`](./fui/phase5-5-tutorial.md)** (2026-05-15)。

サブフェーズ進捗:

- **5.5-a** 設計仕様書 — **完了** ✅
- **5.5-b** WPF `Storyboard` XAML 出力 純粋ロジック (`WpfStoryboardXamlBuilder` + Property / Easing / Shape mapper) — **完了** ✅
- **5.5-c** `WpfStoryboardXamlExporter` (IAnimationExporter 実装) + 出力ダイアログ + 配線 — **完了** ✅
