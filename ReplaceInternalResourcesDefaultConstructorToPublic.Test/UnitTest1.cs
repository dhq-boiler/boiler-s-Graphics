namespace ReplaceInternalResourcesDefaultConstructorToPublic.Test
{
    public class Tests
    {
        [Test]
        public void internalをpublicに置き換える()
        {
            var sourceCode = @"//------------------------------------------------------------------------------
// <auto-generated>
...
";
            File.WriteAllText("test.cs", sourceCode);

            Tool.ReplaceInternalToPublicOnDefaultConstructor("test.cs");

            var correctSourceCode = @"//------------------------------------------------------------------------------
// <auto-generated>
//     このコードはツールによって生成されました。
//     ランタイム バージョン:4.0.30319.42000
//
...
";
            var actual = File.ReadAllText("test.cs");
            Assert.That(actual, Is.EqualTo(correctSourceCode));
        }

        [Test]
        public void publicはpublicのままで()
        {
            var sourceCode = @"//------------------------------------------------------------------------------
// <auto-generated>
//     このコードはツールによって生成されました。
